...
import Policy from "./Components/Home/privacyPolicy.js";
import {AboutUs} from "./Components/Home/Footer.js";
import CourseQuizManagement from "./Components/instructor/quizManagement.js";
  ...
  return (
    <AuthProvider>
      ...
      <Routes>
        ...
        <Route path="/quiz-questions/:quizId" element={<CourseQuizManagement />} />
        <Route
